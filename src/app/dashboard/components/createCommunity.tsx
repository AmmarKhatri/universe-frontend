...
import CreateCommunity from "@/calls/createCommunity";
...
type CreateCommunityModalProps = {
  ...
  onClose: () => void;
  user: UserState;
  setCommunityCreated: (value: boolean) => void;
};
              ...
              <Dialog.Panel className="relative w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                <Formik
                  ...
                  onSubmit={async (values, actions) => {
                    ...
                    try {
                        const response = await CreateCommunity(user.access_token, values.name, values.description);
                          ...
                          <div className="space-y-12">
                            <div className="border-b border-gray-900/10 pb-12">
                              ...
                              <p className="mt-1 text-sm leading-6 text-gray-600">
                                ...
                                after you successfully create a community.
                              </p>
                              <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                ...
                                <div className="col-span-full">
                                  ...
                                  <p className="mt-3 text-sm leading-6 text-gray-600">
                                    Write a few sentences about the community.
                                  </p>
                                </div>
