...
import { ChatBubbleLeftEllipsisIcon, CodeBracketIcon, EllipsisVerticalIcon, EyeIcon, FlagIcon, HandThumbUpIcon, PaperClipIcon, ShareIcon, StarIcon } from "@heroicons/react/24/outline";
import { DeleteIcon, Edit2Icon, PackageIcon, PodcastIcon, TrashIcon, ViewIcon, WatchIcon } from "lucide-react";
...
export default function Postings(props: any){
    ...
    const [posts,setPosts]=useState<any>([]);
      useEffect(()=>{
        ...
        FetchPaginatedPosts(token, posts, setPosts, commid, 0, limit)
      },[commid])
    return(
        <div className="mt-4">
                        ...
                        <div>
                          <div className="flex space-x-3">
                            ...
                            <div className="flex flex-shrink-0 self-center">
                              {post.createdBy._id === userid ? <Menu as="div" className="relative inline-block text-left">
                                <div>
                        ...
                        <div className="mt-6 flex justify-between space-x-8">
                          ...
                          <div className="flex text-sm">
                            <span className="inline-flex items-center text-sm">
                              <a type="button" href={`/communities/${post._id}`} className="inline-flex space-x-2 text-gray-400 hover:text-gray-500">
                                <span className="font-medium text-gray-900">View Post</span>
